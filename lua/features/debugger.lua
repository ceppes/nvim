...
function M.keymaps()
	...
	end, { desc = "Toggle Breakpoint" }) -- local icon = vim.fn.nr2char(61453)
	vim.keymap.set("n", "<leader>dg", function()
		dap.session()
	end, { desc = "Get Session" })
	vim.keymap.set("n", "<leader>di", function()
		dap.step_into()
	end, { desc = " Step Into" }) -- local icon = vim.fn.nr2char(63162)
	vim.keymap.set("n", "<leader>do", function()
		dap.step_over()
	end, { desc = " Step Over" }) -- local icon = vim.fn.nr2char(63164)
	vim.keymap.set("n", "<leader>du", function()
		dap.step_out()
	end, { desc = " Step Out" }) -- local icon = vim.fn.nr2char(63163)
	...
	vim.keymap.set("n", "<leader>ds", function()
		dap.continue()
	end, { desc = " Start" }) -- local icon = vim.fn.nr2char(61515)
	...
	vim.keymap.set("n", "<leader>dp", function()
		dap.pause.toggle()
	end, { desc = " Pause" }) -- local icon = vim.fn.nr2char(63715)
	vim.keymap.set("n", "<leader>dr", function()
		dap.repl.toggle()
